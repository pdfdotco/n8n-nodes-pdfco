	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				placeholder: 'English',
				description: 'Specify the OCR language for text recognition in scanned PDFs. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
			},
			{
