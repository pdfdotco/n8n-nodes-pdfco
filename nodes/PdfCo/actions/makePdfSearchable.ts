...
export const description: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		placeholder: 'English',
		description: 'Specify the language for OCR when extracting text from scanned documents. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				operation: [ActionConstants.MakePdfSearchable],
