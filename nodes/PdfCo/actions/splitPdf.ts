...
export const description: INodeProperties[] = [
	{
		...
		hint: 'Source file URL of the PDF file to split. <a href="https://docs.pdf.co/integrations/n8n/split-pdf" target="_blank">See full guide</a>.',
		displayOptions: {
			show: {
		...
		options: [
			{
				...
				hint: `Use JSON to customize PDF processing with options like output resolution, OCR settings, and more. Check our <a href="https://docs.pdf.co/integrations/n8n/split-pdf#custom-profiles" target="_blank">Custom Profile Guide</a> to see all available parameters for your current operation.`,
			},
			{
			...
			},
			{
				...
				default: '',
				placeholder: 'English',
				description: 'The language to use for OCR. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
			},
			{
